...
console.log(movies[movie.length-1].title)
...
console.log(movie[0].actors[movies[0].actors.length-1])
...
console.log(movie[2].actors[movies[0].actors.length-1])
